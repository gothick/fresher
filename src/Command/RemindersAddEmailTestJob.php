...
class RemindersAddEmailTestJob extends Command
{
    protected static $defaultName = 'app:reminders:addemailtestjob';
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        if ($theme !== false) {
            $reminder = $theme->getReminders()->filter(fn ($r) => $r instanceof ThemeEmailReminder)->first();
            if ($reminder !== false) {
        ...
        $output->writeln('Failed to find either Matt, a theme or an email reminder.');
