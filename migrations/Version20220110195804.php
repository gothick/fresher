 ...
 */
final class Version20220110195804 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE settings (id INT NOT NULL, max_users INT DEFAULT NULL, PRIMARY KEY(id))');
    }
